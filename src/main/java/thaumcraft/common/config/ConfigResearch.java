...
public class ConfigResearch
{
    ...
    private static void initScannables() {
        ...
        ScanningManager.addScannableThing(new ScanBlock("PLANTS", new Block[] { BlocksTC.logGreatwood, BlocksTC.logSilverwood, BlocksTC.saplingGreatwood, BlocksTC.saplingSilverwood, BlocksTC.cinderpearl, BlocksTC.shimmerleaf, BlocksTC.vishroom }));
        ...
        ScanningManager.addScannableThing(new ScanBlock("f_TELEPORT", new Block[] {Blocks.PORTAL, Blocks.END_PORTAL, Blocks.END_PORTAL_FRAME }));
        ...
        ScanningManager.addScannableThing(new ScanBlock("f_DISPENSER", new Block[] { Blocks.DISPENSER }));
        ...
        ScanningManager.addScannableThing(new ScanBlock("f_MATCLAY", new Block[] { Blocks.HARDENED_CLAY, Blocks.STAINED_HARDENED_CLAY }));
        ScanningManager.addScannableThing(new ScanMaterial("f_MATCLAY", new Material[] { Material.CLAY }));
