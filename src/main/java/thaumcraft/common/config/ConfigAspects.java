...
public class ConfigAspects
{
    ...
    private static void registerEntityAspects() {
        ...
        ThaumcraftApi.registerEntityTag("Stray", new AspectList().add(Aspect.UNDEAD, 20).add(Aspect.MAN, 5).add(Aspect.TRAP, 5), new ThaumcraftApi.EntityTagsNBT[0]);
        ThaumcraftApi.registerEntityTag("Thaumcraft.FluxRift", new AspectList().add(Aspect.FLUX, 20).add(Aspect.ELDRITCH, 20).add(Aspect.AURA, 20), new ThaumcraftApi.EntityTagsNBT[0]);
