...
public class TileLampArcane extends TileThaumcraft implements ITickable
{
    ...
    public void update() {
        if (!world.isRemote && world.getTotalWorldTime() % 5L == 0L && !gettingPower()) {
            final int x = world.rand.nextInt(16) - world.rand.nextInt(16);
            final int y = world.rand.nextInt(16) - world.rand.nextInt(16);
            final int z = world.rand.nextInt(16) - world.rand.nextInt(16);
