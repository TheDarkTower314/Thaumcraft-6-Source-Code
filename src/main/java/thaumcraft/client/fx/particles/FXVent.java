...
public class FXVent extends Particle
{
    ...
    public void renderParticle(final BufferBuilder wr, final Entity entity, final float f, final float f1, final float f2, final float f3, final float f4, final float f5) {
        ...
        final float var13 = (float)(this.prevPosX + (this.posX - this.prevPosX) * f - FXVent.interpPosX);
        final float var14 = (float)(this.prevPosY + (this.posY - this.prevPosY) * f - FXVent.interpPosY);
        final float var15 = (float)(this.prevPosZ + (this.posZ - this.prevPosZ) * f - FXVent.interpPosZ);
